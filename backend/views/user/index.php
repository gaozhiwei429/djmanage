...
?>
    <a class="layui-btn layui-btn-radius layui-btn-sm layui-btn-mini" lay-event="edit" data-update="{{d.id}}" data-action="<?=Url::to(['/user/info']);?>?id={{d.id}}">查看</a>
<?php
}
?>
    <a class="layui-btn layui-btn-radius layui-btn-sm layui-btn-danger" lay-event="del">禁用</a>
</script>