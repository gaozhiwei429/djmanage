            ...
            <div class="admin-main layui-form layui-field-box">
                ...
                <form autocomplete="off" class="layui-form" onsubmit="return false;" data-auto="true" action="#">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <select class="combox" name="level" needle="needle" lay-verify="required" msg="您必须为要添加的试题设置一个难度">
                                ...
                                <option value="3" selected>难</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="layeditProblem" name="problem"><?=isset($info['problem']) ? $info['problem']:"";?></textarea>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">参考答案：</label>
                            ...
                            <div id="answerbox_3" class="answerbox" style="display:none;">
                                <div class="layui-input-inline">
                                    <input type="radio" name="targs[questionanswer3]" value="A">对
                                    <input type="radio" name="targs[questionanswer3]" value="B">错
                                </div>
                            </div>
                            <div id="answerbox_4" class="answerbox" style="display:none;">
                                <div class="layui-input-block">
                                    <textarea cols="72" rows="7" id="layeditAnswer" name="targs[questionanswer4]"><?=isset($info['answer']) ? $info['answer']:"";?></textarea>
                                </div>
                            </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="layeditQuestiondescribe" name="analysis"><?=isset($info['analysis']) ? $info['analysis']:"";?></textarea>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
...
<script type="application/javascript">
    layui.use(['form', 'table', 'laypage','layedit'], function(){
        ...
        var index2 = layedit.build('layeditQuestiondescribe',{
            height: 180, //设置编辑器高度
            tool: [
                'html',
                'code',
        ...
        var index2 = layedit.build('layeditProblem',{
            height: 180, //设置编辑器高度
            tool: [
                'html',
                'code',
