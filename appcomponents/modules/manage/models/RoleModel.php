...
//            $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getListData_roleModel_error', $e);
            return [];
        }
    }
    /**
...
//                return $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getCount_roleModel_error', $e);
            return 0;
        }
    }
    ...
    public function addInfo($addData) {
        try {
            ...
            $thisModel->role_name = isset($addData['role_name']) ? trim($addData['role_name']) : "";//区域编码
...
//            return $isSave;
            ...
            DmpLog::error('insert_role_model_error', $e);
            return false;
        }
    }
    ...
    public static function updateInfo($id, $updateInfo) {
        try {
            ...
            DmpLog::error('update_role_model_error', $e);
            return false;
        }
    }
}
