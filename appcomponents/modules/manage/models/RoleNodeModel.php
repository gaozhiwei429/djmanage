...
//            $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getListData_role_node_model_error', $e);
            return [];
        }
    }
    /**
...
//                return $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getCount_role_node_model_error', $e);
            return 0;
        }
    }
    ...
    public function addInfo($addData) {
        try {
            ...
            $thisModel->role_id = isset($addData['role_id']) ? intval($addData['role_id']) : 0;
            $thisModel->node = isset($addData['node']) ? trim($addData['node']) : "";
            $thisModel->status = isset($addData['status']) ? intval($addData['status']) : self::ON_LINE_STATUS;
            $thisModel->save();
            return Yii::$app->db->getLastInsertID();
//            return $isSave;
        } catch (BaseException $e) {
            DmpLog::error('insert_role_node_model_error', $e);
            return false;
        }
    }
    ...
    public static function updateInfo($id, $updateInfo) {
        try {
            ...
            DmpLog::error('update_role_node_model_error', $e);
            return false;
        }
    }
    /**
