...
//            $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getListData_admin_user_role_model_error', $e);
            return [];
        }
    }
    /**
...
//                return $query->createCommand()->getRawSql();
            ...
            DmpLog::warning('getCount_admin_user_role_model_error', $e);
            return 0;
        }
    }
    ...
    public function addInfo($addData) {
        try {
            ...
            $thisModel->admin_user_id = isset($addData['admin_user_id']) ? trim($addData['admin_user_id']) : 0;//管理员用户id
            $thisModel->status = isset($addData['status']) ? intval($addData['status']) : 0;
            $thisModel->save();
            return Yii::$app->db->getLastInsertID();
//            return $isSave;
        } catch (BaseException $e) {
            DmpLog::error('insert_admin_user_role_model_error', $e);
            return false;
        }
    }
    ...
    public static function updateInfo($id, $updateInfo) {
        try {
            ...
            DmpLog::error('update_admin_user_role_model_error', $e);
            return false;
        }
    }
    /**
